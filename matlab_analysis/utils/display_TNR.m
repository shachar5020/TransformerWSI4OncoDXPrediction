...
function display_TNR(TNR_X_vec, TNR_Y_vec, Patients_X_vec, patients_VS_AI, th, Ty, Py)
...
plot(TNR_X_vec, TNR_Y_vec(:, 1), 'color', 'r', 'LineWidth',2.5)
yticks(0:0.1:1); % Define tick positions
h = ylabel('Specificity', 'Color', 'k', 'fontsize', 20);
