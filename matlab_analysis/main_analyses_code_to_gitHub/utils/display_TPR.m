...
function display_TPR(TPR_X_vec, TPR_Y_vec, Patients_X_vec, patients_VS_AI, th, Ty, Py)
...
plot(TPR_X_vec, TPR_Y_vec(:, 1), 'Color', 'r', 'LineWidth', 2.5);
yticks(0:0.1:1); % Define tick positions
h = ylabel('Sensitivity', 'Color', 'k', 'fontsize', 20);
